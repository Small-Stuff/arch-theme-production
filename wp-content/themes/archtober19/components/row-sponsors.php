<?php if(get_field('sponsor_logo')): 
	?><?= (get_field('sponsor_website')) ? '<a class="sponsor_display_'.get_field('sponsor_display_size').'" target="_blank" href="'.get_field('sponsor_website').'"><img src="'.get_field('sponsor_logo').'"></a>' : '<img src="'.get_field('sponsor_logo').'">';
?><?php else: 
